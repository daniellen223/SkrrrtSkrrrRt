...
for i in range(len(learning_rate)):
    ...
    tools.plot_results(100*first_testing_loss,filename=f"FigBeforetrainingLearnrate{learning_rate[i]}", ylabel="% error",title="Before training", show_plot=show_plots)
